---
layout: post
title: "Receiving the keys to our new house"
tags: housing japan
---
...
([This blog post](https://nyanpoko-home.com/ichijo_filter/) talks about these steps in detail.)
...
We also got the manuals and the warranty papers for all the equipment. Since [we went with a custom kitchen]({% post_url 2025-04-12-custom-kitchen-with-ichijo %}) we didn't get any explanation about that (other than to please check and follow the manuals).
